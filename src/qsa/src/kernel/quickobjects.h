...
{
public:
  QuickScriptProperty(QSOT::QuickScriptObjectType t, QuickScriptVariant *v, int on) : type(t), objNum(on) {
    id.var = v;
  }
  QuickScriptProperty(QSOT::QuickScriptObjectType t, QuickScriptObjectFunc *f, int on) : type(t), objNum(on) {
    id.func = f;
  }
  QuickScriptProperty(QSOT::QuickScriptObjectType t, int v, int on) : type(t), objNum(on) {
    id.enumValue = v;
  }
...
public:
  ...
  const QSWrapperClass *wrapperClass() const {
    return cls;
  }
...
public:
  ...
  ~QSUserData();
  QSWrapperShared *data() const {
    return dat;
  }
  void setData(QSWrapperShared *d) {
    dat = d;
  }
  void invalidate() {
    /* dat->deref(); */ dat = 0;
...
public:
  ...
  ~QSWrapperClass();
  QString name() const {
    return QString::fromLatin1("QObject");
  }
...
public:
  QSFactoryObjectProxy(QSClass *base, const QSObject &inst,
    ...
    : QSTypeClass(base),
      ...
      constr(ctor) { }
  QString name() const {
    return QString::fromLatin1("FactoryObject");
  }
...
public:
  ...
  QString name() const {
    return QString::fromLatin1("ObjectConstructor");
  }
  ...
  QSFactoryObjectProxy *proxy() const {
    return m_proxy;
  }
  void setFactoryObjectProxy(QSFactoryObjectProxy *proxy) {
    m_proxy = proxy;
  }
...
public:
  ...
  QString name() const {
    return QString::fromLatin1("Variant");
  }
...
public:
  ...
  QString name() const {
    return QString::fromLatin1("Application");
  }
