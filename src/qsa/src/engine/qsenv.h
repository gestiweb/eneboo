...
public:
  ...
  inline void pushScopeBlock() {
    QSObject obj;
    pushScope(obj);
    labels.push_front(QString::null);
  }
  inline void pushScope(const QSObject &scope) {
    scopeChain->push_front(scope);
  }
  inline void popScope() {
    scopeChain->pop_front();
  }
  inline void popScopeBlock() {
  ...
  inline QSObject currentScope() const {
  ...
  inline QSObject thisValue() const {
    return thVal;
  }
  inline void setThisValue(const QSObject &t) {
    thVal = t;
  }
  inline const QSClass *thisClass() const {
    return thisValue().objectType();
  }
  inline QSObject globalObject() const {
  ...
  bool isExceptionMode() const {
    return execMode == Throw;
  }
  bool isBreakMode() const {
    return execMode == Break;
  }
  bool isContinueMode() const {
    return execMode == Continue;
  }
  bool isReturnValueMode() const {
    return execMode == ReturnValue;
  }
