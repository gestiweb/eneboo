...
public:
  ...
  ~QSClassClass();
  QString name() const {
    return QString::fromLatin1("Class");
  }
...
public:
  ...
  virtual QString name() const {
    return QString::fromLatin1("EvalScope");
  }
  virtual QSObject construct(const QSList &) const;
};
...
public:
  ...
  virtual QString name() const {
    return QString::fromLatin1("BlockScope");
  }
  virtual QSMemberMap members(const QSObject *obj) const;
};
...
public:
  ...
  QString name() const {
    return QString::fromLatin1("Global");  // invisible to the user
  }
};
...
public:
  ...
  QString name() const {
    return QString::fromLatin1("AbstractBase");
  }
