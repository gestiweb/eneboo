...
#ifndef AQUIOBJECTFACTORYQSA_H_
#define AQUIOBJECTFACTORYQSA_H_

#include <AQScript/AQObjectFactoryQSA.h>

class AQUiObjectFactoryQSA : public AQObjectFactoryQSA
{

public:

  AQUiObjectFactoryQSA( AQScriptEngineQSA * eng );
