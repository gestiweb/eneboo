...
AQTabWidgetInterfaceAQ2::AQTabWidgetInterfaceAQ2( const AQScriptEngineQSA * eng,
    QSharedPointer<AQTabWidget> aqTabWidget ) :
    AQComponentDBInterface( eng, aqTabWidget.data() ),
    obj_( aqTabWidget )
{
  AQObjectFactoryQSA::addInterface( obj_, this );
}

AQTabWidgetInterfaceAQ2::~AQTabWidgetInterfaceAQ2()
{
  AQObjectFactoryQSA::removeInterface( obj_ );
}

#include "moc_AQTabWidgetInterface.cpp"
