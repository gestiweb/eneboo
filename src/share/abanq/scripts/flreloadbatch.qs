...
function interna_main()
{
	...
	if (dirAnt)
		dirMods = FileDialog.getExistingDirectory( dirAnt, util.translate( "scripts", "Directorio de Módulos" ) );
	else
		dirMods = FileDialog.getExistingDirectory( false, util.translate( "scripts", "Directorio de Módulos" ) );
