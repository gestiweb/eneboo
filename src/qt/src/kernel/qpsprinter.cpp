...
QPSPrinterPrivate::QPSPrinterPrivate(QPrinter *prt, int filedes) :
  buffer(0), outDevice(0), fd(filedes), pageBuffer(0), fonts(27, FALSE), fontBuffer(0), savedImage(0), dirtypen(FALSE),
                                  ...
                                  const QImage &mask)
{
  ...
  bool gray = (printer->colorMode() == QPrinter::GrayScale) || img.allGray();
