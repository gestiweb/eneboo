                                     ...
                                     QObject *staticDescriptor )
{
    ...
    if ( staticDescriptor ) {
        d->staticDescriptors[ NEW_USTR( className ) ] = staticDescriptor;
    ...
    if ( metaObject ) {
        ...
        d->instanceDescriptors[ NEW_USTR( className ) ] = metaObject->className();
    }
}
...
*/
QMap<uint, QObject*> QSObjectFactory::staticDescriptors() const
{
...
/*!
  ...
  This function should only be used by the interpreter.
*/
QMap<uint, QString> QSObjectFactory::instanceDescriptors() const
{
