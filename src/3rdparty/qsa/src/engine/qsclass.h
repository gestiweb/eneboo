...
public:
    ...
    virtual uint identifier() const
    {
        return HASH_USTR( name() );
    }
    const QSClassClass *asClass() const;
    bool inherits( const QSClass *c ) const;

    QSClass * enclosingClass() const
    {
        return encClass;
    }
    ...
    bool isFinal() const
    {
        return attrs & AttributeFinal;
    }
    bool isExecutable() const
    {
        return attrs & AttributeExecutable;
    }
    bool isAbstract() const
    {
        return attrs & AttributeAbstract;
    }
    ...
    virtual uint toUString( const QSObject *obj ) const;
    ...
    bool hasProperty( const QSObject *obj, uint prop ) const;
    QSObject get( const QSObject *obj, uint prop ) const;
    void put( QSObject *obj, uint prop, const QSObject &v ) const;

    virtual bool deleteProperty( QSObject *obj, const QSMember &mem ) const;
    virtual bool member( const QSObject *o, uint n,
                         QSMember *m ) const;
    ...
    void addFunctionMember( uint n, QSFunctionBodyNode *f,
                            int attributes );
    int addVariableMember( uint n, int attributes );
    void addStaticVariableMember( uint n, const QSObject &v,
                                  int attr );
    void addMember( uint n, const QSMember &m );
    virtual void addMember( uint n, const QSMember &m,
                            const QSObject &stVal );
    virtual bool deleteMember( uint n );
    void replaceMember( uint n, QSMember *m );
    virtual void replaceMember(uint n, QSMember *m,
                                const QSObject &stVal );
    ...
    virtual QSMemberMap * definedMembers() const
    {
        return mmap;
    }
...
public:
    ...
    uint toUString( const QSObject * ) const;
...
{
public:
    QSClassClass( QSClass *b, int a, uint n );
    ~QSClassClass();
    QString name() const
    {
    ...
    QSFunctionBodyNode *classBodyNode() const
    {
        return bodyNode;
    }
    ...
    QSClassDefNode *classDefNode() const
    {
        return clDefNode;
    }
...
public:
    ...
    {
        return QLatin1String( "FunctionScope" );
    }
    virtual uint identifier() const;
...
public:
    ...
    virtual QString name() const
    {
        return QLatin1String( "EvalScope" );
    }
    virtual QSObject construct( const QSList & ) const;
};
...
public:
    ...
    virtual QString name() const
    {
        return QLatin1String( "BlockScope" );
    }
    virtual QSMemberMap members( const QSObject *obj ) const;
...
{
public:
    QSAbstractBaseClass( QSClass *base, uint id )
    ...
    QString name() const
    {
        return QLatin1String( "AbstractBase" );
    }
...
inline void QSClass::replaceMember( uint n, QSMember *m )
{
    replaceMember( n, m, createUndefined() );
}

inline void QSClass::addMember( uint n, const QSMember &m )
{
