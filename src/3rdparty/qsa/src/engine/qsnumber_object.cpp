...
void QSNumberClass::init()
{
    ...
    addStaticVariableMember( REG_USTR( QLatin1String( "NaN" ) ), createNumber( NaN ), a );
    addStaticVariableMember( REG_USTR( QLatin1String( "NEGATIVE_INFINITY" ) ), createNumber( -Inf ), a );
    addStaticVariableMember( REG_USTR( QLatin1String( "POSITIVE_INFINITY" ) ), createNumber( + Inf ), a );
    addStaticVariableMember( REG_USTR( QLatin1String( "MAX_VALUE" ) ), createNumber( 1.7976931348623158e+308 ), a );
    addStaticVariableMember( REG_USTR( QLatin1String( "MIN_VALUE" ) ), createNumber( 2.2250738585072014e-308 ), a );

    // member functions
    addMember( REG_USTR( QLatin1String( "toString" ) ), QSMember( &QSNumberClass::toStringScript ) );
...
{
    return env->createString( NEW_USTR( QSString::from( env->thisValue().dVal() ) ) );
}
