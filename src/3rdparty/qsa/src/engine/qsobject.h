...
class QSShared;
struct QSProperty;
typedef QMap<uint, QSProperty> QSPropertyMap;
class PropList;
class QSMember;
...
public:
    ...
    */
     ...
     */
    bool hasProperty( uint p ) const;
    void put( uint p, const QSObject& v );
    /**
     ...
     */
    bool deleteProperty( uint p );
    /**
     * Convenience function for adding a Number property constructed from
     * a double value.
     */
    void put( uint p, double d );
    /**
     * Convenience function for adding a Number property constructed from
     * an integer value.
     */
    void put( uint p, int i );
    /**
     * Convenience function for adding a Number property constructed from
     * an unsigned integer value.
     */
    void put( uint p, unsigned int u );
    ...
    const QSClass * resolveMember( uint name, QSMember *mem, const QSClass *owner = 0, int *offset = 0 ) const;
...
public:
    ...
    void setProperty( uint n, const QSProperty &p );
    QSProperty *reference( uint n ) const;
    bool hasProperty( uint n ) const;
    QSPropertyMap *properties() const
    {
        return props;
    }
