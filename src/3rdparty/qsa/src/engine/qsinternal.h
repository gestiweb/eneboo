...
public:
    ...
    QString name() const
    {
        return QLatin1String( "Arguments" );
    }
...
private:
    ...
    bool evaluate( const QString &code, const QSObject *thisV = 0,
                   ...
                   int lineZero = 0 );
    bool evaluateByteCode( const QByteArray &code, const QSObject *thisV = 0,
                   bool onlyCheckSyntax = false, int checkMode = 0,
                   int lineZero = 0 );
    bool evaluateByteCode( QDataStream & in, const QSObject *thisV = 0,
                   bool onlyCheckSyntax = false, int checkMode = 0,
                   int lineZero = 0 );
