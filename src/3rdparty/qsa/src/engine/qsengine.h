...
public:
    ...
    bool evaluateByteCode( const QSObject &thisV, const QByteArray &code, int linezero = 0 );
    bool evaluateByteCode( const QSObject &thisV, QDataStream & in, int linezero = 0 );
    /**
