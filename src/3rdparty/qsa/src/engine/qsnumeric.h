...
{
    const double *ret = reinterpret_cast<const double *>(QSysInfo::ByteOrder == QSysInfo::BigEndian ? qsa_be_inf_bytes : qsa_le_inf_bytes);
    return *ret;
}
...
{
    const double *ret = reinterpret_cast<const double *>(QSysInfo::ByteOrder == QSysInfo::BigEndian ? qsa_be_snan_bytes : qsa_le_snan_bytes);
    return *ret;
}
...
{
    const double *ret = reinterpret_cast<const double *>(QSysInfo::ByteOrder == QSysInfo::BigEndian ? qsa_be_qnan_bytes : qsa_le_qnan_bytes);
    return *ret;
}
