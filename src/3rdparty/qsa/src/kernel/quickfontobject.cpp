...
{
    int a = AttributeNone;
    addMember( REG_USTR( QLatin1String( "family" ) ), QSMember( QSMember::Custom, FMT_Family, a ) );
    addMember( REG_USTR( QLatin1String( "pointSize" ) ), QSMember( QSMember::Custom, FMT_PointSize, a ) );
    addMember( REG_USTR( QLatin1String( "pixelSize" ) ), QSMember( QSMember::Custom, FMT_PixelSize, a ) );
    addMember( REG_USTR( QLatin1String( "weight" ) ), QSMember( QSMember::Custom, FMT_Weight, a ) );
    addMember( REG_USTR( QLatin1String( "bold" ) ), QSMember( QSMember::Custom, FMT_Bold, a ) );
    addMember( REG_USTR( QLatin1String( "italic" ) ), QSMember( QSMember::Custom, FMT_Italic, a ) );
    addMember( REG_USTR( QLatin1String( "underline" ) ), QSMember( QSMember::Custom, FMT_Underline, a ) );
    addMember( REG_USTR( QLatin1String( "strikeout" ) ), QSMember( QSMember::Custom, FMT_StrikeOut, a ) );
    addMember( REG_USTR( QLatin1String( "fixedPitch" ) ), QSMember( QSMember::Custom, FMT_FixedPitch,
...
QFont *QSFontClass::font( const QSObject *obj ) const
{
    ...
    return &( static_cast<FontShared *>( obj->shVal() ) ->font );
}
