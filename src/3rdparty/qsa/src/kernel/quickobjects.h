...
public:
    ...
    const QVector<QObject *> *interfaceObjects() const
    {
        return & objects;
    }
    ...
    QMap<uint, QList<int> > cached_slots;
    QMap<uint, QSMember> cached_members;
...
public:
    ...
    QString name() const
    {
        return QLatin1String( "FactoryObject" );
    }
...
public:
    ...
    QSObjectConstructor( QSClass *b, uint className, Type t = Class );
    QString name() const
    {
        return QLatin1String( "ObjectConstructor" );
    }
    ...
    bool member( const QSObject *objPtr, uint name, QSMember *m ) const;
...
public:
    ...
    virtual QSMemberMap members( const QSObject *obj ) const;
    virtual bool member( const QSObject *o, uint n, QSMember *m ) const;
