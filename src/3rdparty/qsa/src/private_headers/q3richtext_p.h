...
public:
    ...
    Q3TextStringChar() : nobreak( false ), lineStart( 0 ), type( Regular )
    {
        p.format = 0;
    }
    ~Q3TextStringChar();
...
uchar rightToLeft : 1;
    ...
    bool isAnchor() const
    {
        return ( type & Anchor ) != 0;
    }
    bool isLink() const
    {
        return isAnchor() && p.custom->anchorHref.count();
    }
...
public:
    ...
    {
        rightToLeft = ( dr == QChar::DirR ); bidiDirty = true;
    }

    QVector<Q3TextStringChar> rawData() const
    {
        return data;
    }
...
public:
    ...
    inline Q3TextParagraph *paragraph() const
    {
        return para;
    }
    ...
    {
        return paras.isEmpty() ? para : paras.first();
    }
    int offsetX() const
    {
        return ox;
    } // inner document  offset
    int offsetY() const
    {
        return oy;
    } // inner document offset
...
inline int Q3TextFlow::width() const
{
    return w;
}
...
public:
    ...
    Q3TextDocument* richText() const
    {
        return richtext;
    }
    Q3TextTable* table() const
    {
        return parent;
    }
...
public:
    ...
    QList<Q3TextTableCell *> tableCells() const
    {
        return cells;
    }
...
public:
    ...
    Q3TextDocument *parent() const
    {
        return par;
    }
    Q3TextParagraph *parentParagraph() const
    {
        return parentPar;
    }
...
#ifndef QT_NO_MIME
    void setMimeSourceFactory( Q3MimeSourceFactory *f )
    {
        if ( f ) factory_ = f;
    }
#endif
    ...
    {
        if ( backBrush ) delete backBrush; backBrush = brush;
    }
    QBrush *paper() const
    {
        return backBrush;
    ...
    void setTableCell( Q3TextTableCell *c )
    {
        tc = c;
    }
#endif
    ...
    void setUndoDepth( int depth )
    {
        commandHistory->setUndoDepth( depth );
    }
    int undoDepth() const
    {
    ...
    void insertChild( Q3TextDocument *dc )
    {
        childList.append( dc );
    }
    void removeChild( Q3TextDocument *dc )
    {
        childList.removeAll( dc );
    }
    QList<Q3TextDocument *> children() const
    {
        return childList;
    }
...
public:
    ...
    Q3TextCursor *execute( Q3TextCursor *c )
    {
        return Q3TextDeleteCommand::unexecute( c );
    }
    Q3TextCursor *unexecute( Q3TextCursor *c )
    {
        return Q3TextDeleteCommand::execute( c );
    }
...
public:
    ...
    {
        lstyle = ls; changed = true;
    }
    Q3StyleSheetItem::ListStyle listStyle() const
    {
        return ( Q3StyleSheetItem::ListStyle ) lstyle;
    }
...
public:
    ...
    {
        if ( !wrapEnabled ) return false; if ( p && !p->isBreakable() ) return false; return true;
    }
...
public:
    ...
    virtual Q3TextFormat *createFormat( const Q3TextFormat &f )
    {
        return new Q3TextFormat( f );
    }
    virtual Q3TextFormat *createFormat( const QFont &f, const QColor &c )
    {
        return new Q3TextFormat( f, c, this );
    }
...
inline Q3TextParagraphPseudoDocument *Q3TextParagraph::pseudoDocument() const
{
    if ( hasdoc )
        return 0;
    return static_cast<Q3TextParagraphPseudoDocument *>( docOrPseudo );
}
