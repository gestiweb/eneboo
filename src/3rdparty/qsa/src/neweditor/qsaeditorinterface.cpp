...
bool QSAEditorInterface::find( const QString &, bool, bool, bool, bool )
{
  if ( !d->editor )
    return false;
  return false;
...
bool QSAEditorInterface::replace( const QString &, const QString &, bool, bool,
                                  bool, bool, bool )
{
  if ( !d->editor )
    return false;
...
void QSAEditorInterface::scrollTo( const QString &, const QString & )
{
  if ( !d->editor )
    return ;
}
...
void QSAEditorInterface::setStep( int )
{
  if ( !d->editor )
    return ;
}
...
void QSAEditorInterface::setStackFrame( int )
{
  if ( !d->editor )
    return ;
}
