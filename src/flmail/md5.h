 ...
 */
/* $Id: md5.h,v 1.4 2004/10/28 16:19:24 eug Exp $ */
/*
...
typedef AQMAIL_EXPORT unsigned char md5_byte_t; /* 8-bit byte */
typedef AQMAIL_EXPORT unsigned int md5_word_t; /* 32-bit word */

/* Define the state of the MD5 Algorithm. */
typedef AQMAIL_EXPORT struct md5_state_s {
...
extern "C"
{
    ...
    AQMAIL_EXPORT void md5_init(md5_state_t *pms);

    /* Append a string to the message. */
    AQMAIL_EXPORT void md5_append(md5_state_t *pms, const md5_byte_t *data, int nbytes);

    /* Finish the message and return the digest. */
    AQMAIL_EXPORT void md5_finish(md5_state_t *pms, md5_byte_t digest[16]);
